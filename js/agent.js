...
<div id="ai-chat" class="ai-chat">
  ...
  <div class="ai-messages" id="ai-messages">
    <div class="ai-msg bot">
      <div class="ai-bubble">
        أهلاً! 👋 أنا <strong>سامي</strong>، مستشارك العقاري الذكي.<br>
        يسعدني الإجابة على جميع استفساراتك عن هذه الفيلا الاستثنائية.<br><br>
...
.ai-btn {
  ...
  background: linear-gradient(135deg, #1a3c5e, #2a5280);
  border-radius: 50%;
...
@media (max-width: 480px) {
  .ai-chat { width: calc(100vw - 20px); left: 10px; bottom: 10px; }
  .ai-btn { bottom: 150px; }
}
</style>
`;
